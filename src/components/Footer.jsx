    ...
    <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden' id='Footer'>
        <div className='conatiner mx-auto flex flex-col md:flex-row justify-between items-start'>
            <div className='w-full md:w-1/3 mb-8 md:mb-0'>
                ...
                <p className='text-gray-400 mt-4'>Lorum Ipsum is simple dummy text of the Printing and typesetting
                    industry. Lorum Ipsum has been the industry's standard dummy text.
                </p>
            </div>
        ...
        text-gray-500'>
            copyright 2025 @Bhavya. All Right Reserved.
        </div>
    </div>
  )
}
